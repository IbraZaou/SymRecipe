 ...
 */
final class Version20231013094006 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_recipe_dislike (recipe_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_D95A3DB359D8A214 (recipe_id), INDEX IDX_D95A3DB3A76ED395 (user_id), PRIMARY KEY(recipe_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
