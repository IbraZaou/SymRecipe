 ...
 */
final class Version20231012142440 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_recipe_like (recipe_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_7A63D3F959D8A214 (recipe_id), INDEX IDX_7A63D3F9A76ED395 (user_id), PRIMARY KEY(recipe_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
